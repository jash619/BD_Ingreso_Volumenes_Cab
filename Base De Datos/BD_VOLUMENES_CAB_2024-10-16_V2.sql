...
CREATE TABLE `municipios` (
  ...
  CONSTRAINT `dpto_id` FOREIGN KEY (`departamento_id`) REFERENCES `departamentos` (`id_departamento`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2024-10-16 18:29:01
